...
class ReplicantTransportChallenge(Replicant):
    ...
    def __init__(self, replicant_id: int, state: ChallengeState,
        ...
        :param image_frequency: An [`ImageFrequency`](https://github.com/threedworld-mit/tdw/blob/master/Documentation/python/replicant/image_frequency.md) value that sets how often assets are captured.
    ...
    def move_to_object(self, target: int) -> None:
        ...
        """
        self.move_to(target=target, reset_arms=False, arrived_at=0.7) #if target in self._state.target_object_ids else 0.1_1)
