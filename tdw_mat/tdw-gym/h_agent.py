...
class H_agent:
    ...
    def _reset(self):
        ...
        #0: free, 1_1: target object, 2: container, 3: goal
    ...
    def detect(self):
        ...
        #self.detection_model(self.obs['rgb'][..., [2, 1_1, 0]], decode = False, no_save_pred = False, out_dir = 'outputs')
