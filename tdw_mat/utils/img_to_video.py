...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_folder", default='/home/jie/code/AIAgent/MetaPlan_v4/tdw_mat/results/run_vis/run_0/23_1/top_down_image', type=str, help="image path")
    parser.add_argument("--video_name", type=str, default="video_2.avi")
